...
class Review(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=("deal", "reviewer"), name="unique_review_per_deal_reviewer"),
        ]
        ordering = ("-created_at",)

    def __str__(self):
        return f"Review by {self.reviewer_id} for {self.reviewee_id} on deal {self.deal_id}"
